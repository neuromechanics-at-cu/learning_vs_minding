...
load('../../Data/Model Fits/Cost Weight Analysis Fits (Fig 5)/CostRatios_From_Fits.mat')
...
%             if exist(['../../Data/Model Fits/Cost Weight Analysis Fits (Fig 5)/',...
%                     subjNames{iii},'-',num2str(runNames(kkk)),'-alpha',num2str(alphaNames(jjj)),'.mat'])
%                 load(['../../Data/Model Fits/Cost Weight Analysis Fits (Fig 5)/',...
%                     subjNames{iii},'-',num2str(runNames(kkk)),'-alpha',num2str(alphaNames(jjj)),'.mat'])
...
%% Figure 5: Ratio of Normalized Kinematic Costs to Normalized Effort Costs
...
for ii = 1:length(alphaNames)
    semilogy([alphaNames,alphaNames],squeeze(err2force(1,:,ii)),'.','MarkerSize',20,'color',colors(1,:))
    semilogy([alphaNames,alphaNames],squeeze(err2force(2,:,ii)),'.','MarkerSize',20,'color',colors(2,:))
