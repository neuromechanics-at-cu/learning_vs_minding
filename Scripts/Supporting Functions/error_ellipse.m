...
%   h1=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style);hold on
  h1=plot3(x0+k*x,y0+k*y,z0+k*z,'Color',[190/255,190/255,190/255]);hold on
  [y,z,x] = getpoints(Cyz,prop.clip);
%   h2=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style);hold on
  h2=plot3(x0+k*x,y0+k*y,z0+k*z,'Color',[190/255,190/255,190/255]);hold on
  [z,x,y] = getpoints(Czx,prop.clip);
%   h3=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style);hold on
  h3=plot3(x0+k*x,y0+k*y,z0+k*z,'Color',[190/255,190/255,190/255]);hold on
...
%   h1=plot(scale*(x0+k*x),scale*(y0+k*y),prop.style);
  h1=plot(scale*(x0+k*x),scale*(y0+k*y),'Color',[190/255,190/255,190/255]);
%   set(h1,'zdata',z+1)
  if nargout
    h=h1;
  end
